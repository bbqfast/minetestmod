...
--  "[combine:8x8:0,0=character_Mary_LT_mt.png^[sheet:8x4:1,0"
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png",  "[combine:8x8:0,0=character_Mary_LT_mt.png^[sheet:8x4:1,0")
    -- "[combine:8x8:0,0=character_Mary_LT_mt.png^[sheet:8x4:1,0"
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png",  "[combine:32x32:0,0=character_Mary_LT_mt.png^[sheet:32x32:0,0")
...
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png",  "character_Mary_LT_mt.png^[sheet:6x2:2,1")
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png",  prev)
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png[contrast:100:100¶",  prev)
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png^[invert:rgb",  prev)
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png^[contrast:127:127",  prev)
-- register_lt("mary", "Mary LT", "character_Mary_LT_mt.png^[opacity:255",  prev)
register_lt("mary", "Mary LT", "character_Mary_LT_mt.png^[invert:b",  prev)

-- register_lt("alisa", "Alisa LT", "character_player_Alisa2_mt.png",  get_preview("character_player_Alisa2_mt.png"))
register_lt("alisa", "Alisa LT", "character_player_Alisa2_mt.png^[brighten:80",  get_preview("character_player_Alisa2_mt.png"))
...
-- register_lt("dusk", "dusk", "character_player_Dusk_mt.png",  "[combine:8x8:0,0=character_player_Dusk_mt.png^[sheet:8x4:1,0")
-- register_lt("dusk", "dusk", "character_player_Dusk_mt.png",  "[combine:64x32:0,0=character_player_Dusk_mt.png^[sheet:64x32:0,0")

-- register_lt("dusk", "dusk", "character_player_Dusk_mt.png",  "character_player_Dusk_mt.png^[invert:rgb")
-- register_lt("dusk", "dusk", "character_player_Dusk_mt.png",  "character_player_Dusk_mt.png^[sheet:8x4:1,0")
register_lt("dusk", "dusk", "character_player_Dusk_mt.png",  "character_player_Dusk_mt.png^[sheet:8x4:1,1")
